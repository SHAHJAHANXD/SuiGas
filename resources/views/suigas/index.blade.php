...
<head>
	...
	<link href="{{url('xhtml/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css')}}" rel="stylesheet">
...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="#" class="brand-logo">
                <!-- <img class="logo-abbr" src="{{url('xhtml/images/suigas.png')}}" alt=""> -->
                <img class="logo-compact" src="{{url('xhtml/images/sui.png')}}" alt="">
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{url('xhtml/images/avatar/1.jpg')}}" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{url('xhtml/images/avatar/2.jpg')}}" class="rounded-circle user_img" alt=""/>
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{url('xhtml/images/avatar/3.jpg')}}" class="rounded-circle user_img" alt=""/>
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{url('xhtml/images/avatar/4.jpg')}}" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{url('xhtml/images/avatar/5.jpg')}}" class="rounded-circle user_img" alt=""/>
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="{{url('xhtml/images/avatar/1.jpg')}}" class="rounded-circle user_img_msg" alt=""/>
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
								<img src="{{url('xhtml/images/avatar/2.jpg')}}" class="rounded-circle user_img_msg" alt=""/>
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
			...
			<div class="container-fluid">
				<div class="form-head d-flex align-items-center mb-sm-4 mb-3">
					<div class="mr-auto">
						...
						<p class="mb-0">Sui Gas Dashboard</p>
					</div>
					...
					<div class="col-xl-3 col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="fs-34 text-black font-w600">{{$superadmins}}</h2>
							...
							<div class="progress  rounded-0" style="height:4px;">
								<div class="progress-bar rounded-0 bg-secondary progress-animated" style="width: {{$superadmins}}%; height:4px;" role="progressbar">
									<span class="sr-only">{{$superadmins}}% Complete</span>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-3  col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="fs-34 text-black font-w600">{{$admins}}</h2>
							...
							<div class="progress  rounded-0" style="height:4px;">
								<div class="progress-bar rounded-0 bg-secondary progress-animated" style="width: {{$admins}}%; height:4px;" role="progressbar">
									<span class="sr-only">{{$admins}}% Complete</span>
								</div>
							</div>
						</div>
					</div>
					<div class="col-xl-3  col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="fs-34 text-black font-w600">{{$users}}</h2>
							...
							<div class="progress  rounded-0" style="height:4px;">
								<div class="progress-bar rounded-0 bg-secondary progress-animated" style="width: {{$users}}%; height:4px;" role="progressbar">
					...
					<div class="col-xl-3  col-sm-6">
						<div class="card">
							<div class="card-body">
								<div class="media align-items-center">
									<div class="media-body mr-3">
										<h2 class="fs-34 text-black font-w600">{{$records}}</h2>
							...
							<div class="progress  rounded-0" style="height:4px;">
								<div class="progress-bar rounded-0 bg-secondary progress-animated" style="width: {{$records}}%; height:4px;" role="progressbar">
									<span class="sr-only">{{$records}}% Complete</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
											...
											<div class="tab-pane fade show active" id="Daily" role="tabpanel">
												<div class="d-flex flex-wrap align-items-center px-4 bg-light">
													...
													<ul class="users pl-3 py-2">
														<li><img src="{{url('xhtml/images/users/1.png')}}" alt=""></li>
														<li><img src="{{url('xhtml/images/users/2.png')}}" alt=""></li>
														<li><img src="{{url('xhtml/images/users/3.png')}}" alt=""></li>
														<li><img src="{{url('xhtml/images/users/4.png')}}" alt=""></li>
														<li><img src="{{url('xhtml/images/users/5.png')}}" alt=""></li>
													</ul>
												</div>
								...
								<div class="card">
									...
									<div class="card-body pb-0">
										<ul class="users-sm mb-3">
											<li><img src="{{url('xhtml/images/users/6.png')}}" alt=""></li>
											<li><img src="{{url('xhtml/images/users/7.png')}}" alt=""></li>
											<li><img src="{{url('xhtml/images/users/8.png')}}" alt=""></li>
											<li><img src="{{url('xhtml/images/users/9.png')}}" alt=""></li>
											<li><img src="{{url('xhtml/images/users/10.png')}}" alt=""></li>
										</ul>
										<div class="d-flex align-items-center">
							...
							<div class="col-xl-12">	
								<div class="card rated-doctors">
									<div class="card-header border-0 pb-0">
										<h3 class="fs-20 text-black mb-0 mr-auto">Users</h3>
									...
									<div class="card-body">
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<img src="{{url('xhtml/images/users/2.jpg')}}" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<img src="{{url('xhtml/images/users/3.jpg')}}" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<img src="{{url('xhtml/images/users/4.jpg')}}" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
										...
										<div class="d-sm-flex pb-sm-4 pb-3 border-bottom mb-sm-4 mb-3 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<img src="{{url('xhtml/images/users/5.jpg')}}" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
										...
										<div class="d-sm-flex pb-0 align-items-center">
											<div class="d-flex align-items-center mr-auto pr-2">
												...
												<img src="{{url('xhtml/images/users/1.jpg')}}" class="img-1 mr-sm-4 mr-3" alt="">
												<div>
													<h4 class="mb-sm-2 mb-1"><a href="doctor.html" class="text-black">Dr. Abdul Aziz Lazis</a></h4>
													<span class="fs-14 text-primary font-w600">Gynecologist</span>
												</div>
							...
							<div class="col-xl-12">	
								<div class="card appointment-schedule">
									<div class="card-header pb-0 border-0">
										<h3 class="fs-20 text-black mb-0">Calender</h3>
										<div class="dropdown ml-auto">
											...
											<table class="table table-responsive-sm">
												<tbody>
													<tr>
														<td>
															<div class="d-flex">
																<img src="{{url('xhtml/images/users/6.jpg')}}" alt="" class="img-2 mr-3">
																<div>
													...
													<tr>
														<td>
															<div class="d-flex">
																<img src="{{url('xhtml/images/users/7.jpg')}}" alt="" class="img-2 mr-3">
																<div>
													...
													<tr>
														<td>
															<div class="d-flex">
																<img src="{{url('xhtml/images/users/8.jpg')}}" alt="" class="img-2 mr-3">
																<div>
													...
													<tr>
														<td>
															<div class="d-flex">
																<img src="{{url('xhtml/images/users/9.jpg')}}" alt="" class="img-2 mr-3">
																<div>
													...
													<tr>
														<td>
															<div class="d-flex">
																<img src="{{url('xhtml/images/users/10.jpg')}}" alt="" class="img-2 mr-3">
																<div>
													...
													<tr>
														<td>
															<div class="d-flex">
																<img src="{{url('xhtml/images/users/11.jpg')}}" alt="" class="img-2 mr-3">
																<div>
    ...
    ***********************************-->
	...
	<script src="{{url('xhtml/vendor/bootstrap-datetimepicker/js/moment.js')}}"></script>
	<script src="{{url('xhtml/vendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js')}}"></script>
	<!-- Chart piety plugin files -->
    <script src="{{url('xhtml/vendor/peity/jquery.peity.min.js')}}"></script>
	
	<!-- Apex Chart -->
	<script src="{{url('xhtml/vendor/apexchart/apexchart.js')}}"></script>
	
	<!-- Dashboard 1 -->
	<script src="{{url('xhtml/js/dashboard/dashboard-1.js')}}"></script>
	<script>
		$(function () {
