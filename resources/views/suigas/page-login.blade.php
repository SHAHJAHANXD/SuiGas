...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="{{url('xhtml/image/png')}}" sizes="16x16" href="{{url('xhtml/images/favicon.png')}}">
                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
									<div class="text-center mb-3">
										<a href="{{url('xhtml/index.html')}}"><img src="{{url('xhtml/images/suigas.png')}}" alt=""></a>
									</div>
