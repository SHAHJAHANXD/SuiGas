                            ...
                            <div class="card-body">
								<div id="smartwizard" class="form-wizard order-create">
									<div class="tab-content">
											<form action="{{url('monthdataupdate')}}" method="Post">
												@csrf
												<input type="hidden" name="id" value="{{$monthlychanges->id}}">
											<div class="row">
												...
												<div class="col-lg-3 mb-4">
													<div class="form-group">
														...
														<input type="text" name="status_1" value="{{$monthlychanges->status_1}}" class="form-control">
													</div>
												</div>
												<div class="col-lg-3 mb-4">
													<div class="form-group">
														<label class="text-label">2 NOC Dept.</label>
														<input type="text" name="two_noc_dept" value="{{$monthlychanges->two_noc_dept}}" class="form-control">
													</div>
												</div>
												<div class="col-lg-4 mb-4">
													<div class="form-group">
														<label class="text-label">Look Ahead Plan</label>
														<input type="text" name="look_ahead_plan" value="{{$monthlychanges->look_ahead_plan}}" class="form-control">
													</div>
												</div>
												<div class="col-lg-12 mb-2">
												...
												<div class="col-lg-4 mb-4">
													<div class="form-group">
														...
														<input type="text" name="welding_material_booking_1_8_6010_kgs" value="{{$monthlychanges->welding_material_booking_1_8_6010_kgs}}" class="form-control">
													</div>
												</div>
												<div class="col-lg-4 mb-4">
													<div class="form-group">
														<label class="text-label">5/32 7010 (Kgs)</label>
														<input type="text" name="welding_material_booking_5_32_7010_kgs" value="{{$monthlychanges->welding_material_booking_5_32_7010_kgs}}" class="form-control">
													</div>
												</div>
												<div class="col-lg- mb-4">
													<div class="form-group">
														<label class="text-label">3/16 7010 (Kgs)</label>
														<input type="text" name="welding_material_booking_3_16_7010_kgs" value="{{$monthlychanges->welding_material_booking_3_16_7010_kgs}}" class="form-control">
													</div>
												</div>
												<div class="col-lg-4 mb-4">
													<div class="form-group">
														<label class="text-label">CUTTING DISC (Nos)</label>
														<input type="text" name="welding_material_booking_cutting_disc_nos" value="{{$monthlychanges->welding_material_booking_cutting_disc_nos}}" class="form-control">
													</div>
												</div>
												<div class="col-lg-4 mb-4">
													<div class="form-group">
														<label class="text-label">GRINDING DISC (Nos)</label>
														<input type="text" name="welding_material_booking_grinding_disc_nos" value="{{$monthlychanges->welding_material_booking_grinding_disc_nos}}" class="form-control">
													</div>
												</div>
												<div class="col-lg-4 mb-4">
													<div class="form-group">
														<label class="text-label">POWER BRUSH (Nos)</label>
														<input type="text" name="welding_material_booking_power_brush_nos" value="{{$monthlychanges->welding_material_booking_power_brush_nos}}" class="form-control">
													</div>
												</div>
												<div class="col-lg-12 mb-2">
												<h2>BUDGET</h2><br>
												...
												<div class="col-lg-4 mb-4">
													<div class="form-group">
														...
														<input type="text" name="actual" value="{{$monthlychanges->actual}}" class="form-control">
													</div>
												</div>
												<div class="col-lg-4 mb-4">
													<div class="form-group">
														<label class="text-label">BALANCE</label>
														<input type="text" name="balance" value="{{$monthlychanges->balance}}" class="form-control">
													</div>
												</div>
												</div>
